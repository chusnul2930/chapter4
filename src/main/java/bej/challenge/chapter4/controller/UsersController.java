...
public class UsersController {
    ...
    public ResponseEntity<MessageModel> deleteById(@PathVariable("usersId") String usersId) {
        MessageModel msg = new MessageModel();
        try {
    ...
    @GetMapping("/getData/{usersId}")
    public ResponseEntity<MessageModel> getById(@PathVariable("usersId") String usersId) {
        MessageModel msg = new MessageModel();
        try {
            Users data = usersRepository.getById(usersId);
    ...
    @GetMapping("/getList")
    public ResponseEntity<MessageModel> getDataAll() {
        MessageModel msg = new MessageModel();
        try {
